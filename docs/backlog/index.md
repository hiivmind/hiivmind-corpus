...
| 03 | [Tiered v2 rendering → v1 migration → retire v1](03-retire-v1-tiered-v2-rendering.md) | **P3** | In progress (wave 2 merged; flyio migrated in flyio PR #5; v1 write-path deletion deferred one release) | L | internal sequencing | Make tiering a render-time concern of index.yaml, ship a migrate skill, move flyio off v1, delete v1 write paths. |
